		...
		<div id="wrapper">
			...
			<!-- Header -->
				<header id="header">
					<div class="inner">
						...
						<!-- Introduction -->
						<a href="#" class="image avatar"><img src="images/5gold.jpg" alt="" /></a>
			...
			<!-- Menu -->
				<nav id="menu">
					<h2>Menu</h2>
					<ul>
						<li><a href="index.html">修改個人資料</a></li>
						<li><a href="generic.html">預約紀錄查詢</a></li>
						<li><a href="generic.html">購物紀錄查詢</a></li>
					</ul>
				</nav>
						...
						<section id="two">
							...
							<div class="row">
								<article class="6u 12u$(xsmall) work-item">
									<a href="images/pic01.jpg" class="image fit thumb">
										<img src="images/pic01.jpg" alt="" />
										<h3>如何當一個假掰的工程師</h3>
									</a>
								</article>
								<article class="6u$ 12u$(xsmall) work-item">
									<a href="images/pic03.jpg" class="image fit thumb">
										<img src="images/pic03.jpg" alt="" />
										<h3>Title</h3>
									</a>
								</article>
								<article class="6u 12u$(xsmall) work-item">
									<a href="images/pic05.jpg" class="image fit thumb">
										<img src="images/pic05.jpg" alt="" />
										<h3>Title</h3>
									</a>
								</article>
								<article class="6u$ 12u$(xsmall) work-item">
									<a href="images/pic07.jpg" class="image fit thumb">
										<img src="images/pic07.jpg" alt="" />
										<h3>Title</h3>
									</a>
								</article>
								<article class="6u 12u$(xsmall) work-item">
									<a href="images/pic09.jpg" class="image fit thumb">
